...
template <> TemplateField<ZpKaratsubaElement>::TemplateField(long fieldParam) {
 ...
 */
template <> GF2E TemplateField<GF2E>::GetElement(long b) {
...
template <> ZZ_p TemplateField<ZZ_p>::GetElement(long b) {
 ...
 */
template <> TemplateField<GF2E>::TemplateField(long fieldParam) {
...
template <>
void TemplateField<GF2E>::elementToBytes(unsigned char *elemenetInBytes,
                                         GF2E &element) {
...
template <>
void TemplateField<ZpKaratsubaElement>::elementToBytes(
    unsigned char *elemenetInBytes, ZpKaratsubaElement &element) {

  memcpy(elemenetInBytes, (byte *)(&element.elem), 5);
}

template <>
void TemplateField<ZpKaratsubaElement>::elementVectorToByteVector(
    vector<ZpKaratsubaElement> &elementVector, vector<byte> &byteVector) {

  // TBD
}

template <>
ZpKaratsubaElement TemplateField<ZpKaratsubaElement>::bytesToElement(
...
template <>
void TemplateField<ZZ_p>::elementToBytes(unsigned char *elemenetInBytes,
                                         ZZ_p &element) {
...
template <>
void TemplateField<GF2E>::elementVectorToByteVector(vector<GF2E> &elementVector,
                                                    vector<byte> &byteVector) {
